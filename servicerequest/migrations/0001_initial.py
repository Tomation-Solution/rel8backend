# Generated by Django 3.2.13 on 2023-02-20 20:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proceed_to_update_your_profile', models.FileField(upload_to='proceed_to_update_your_profile/%m/%d/')),
                ('submit_most_recent_financial_statement', models.FileField(upload_to='submit_most_recent_financial_statement/%m/%d/')),
                ('upload_all_levy_recipt', models.FileField(upload_to='upload_all_levy_recipt/%m/%d/')),
                ('upload_Product_update_report', models.FileField(upload_to='upload_Product_update_report/%m/%d/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload_membership_cert_for_both_companies', models.FileField(upload_to='Upload_membership_cert_for_both_companies/%m/%d/')),
                ('member', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='account.memeber')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submit_most_recent_financial_statement', models.FileField(upload_to='submit_most_recent_financial_statement/%m/%d/')),
                ('upload_dues_reciept', models.FileField(upload_to='Upload_dues_reciept/%m/%d/')),
                ('upload_factory_inspection_report', models.FileField(upload_to='upload_factory_inspection_report/%m/%d/')),
                ('member', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='account.memeber')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('deactivation_request', models.FileField(upload_to='deactivation_request/%m/%d/')),
                ('submit_most_recent_financial_statement', models.FileField(upload_to='submit_most_recent_financial_statement/%m/%d/')),
                ('upload_all_levy_recipt', models.FileField(upload_to='upload_all_levy_recipt/%m/%d/')),
                ('member', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='account.memeber')),
            ],
